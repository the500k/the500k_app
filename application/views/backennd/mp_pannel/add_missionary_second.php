                    ...
                    ?>
                                ...
                                <div class="form-group">
                                  <label for="name">What is the PIN (post code) of the primary village or place where FW intends to minister and plant a church<span class="required">(optional)</span></label>
                                    <input   style="color: #000000;" class="form-control" data-validate-length-range="12" name="pincode" id="pincode" placeholder="625019" type="number">
                                </div>
                                <div class="form-group">
                                 ...
                                 echo form_dropdown('mf_type',$op_mf_type,"",$class_state);
                     ?>  
                                ...
                                <div class="form-group">
                                  <label for="name">Has the FW already begun ministry in this place?<span class="required">*</span></label>
                                    <select name="is_fw_active_in_mf" id="is_fw_active_in_mf" class="form-control" required="required" onchange="set_fields()">
                                        <option value=""></option>
                            ...
                            <div id="hidden_fields" style="display: none">
                                <div class="form-group">
                                  <label for="name">When did the FW begin their ministry in this place? Please share the date. If they have not yet started, please write N/A<span class="required">*</span></label>
                                    <input   style="color: #000000;" class="form-control" data-validate-length-range="12" name="mf_starting_date" id="mf_starting_date" placeholder="19-12-2006"  type="date">
                                </div>
                                <div class="form-group">
                                  ...
                                  <input   style="color: #000000;" class="form-control" data-validate-length-range="12" name="desc_mf" id="desc_mf" placeholder="1000"  type="number">
                                </div>
                                ...
                                <div class="form-group">
                                  <label for="name">If the FW has already begun their ministry, how many baptized church members are there?<span class="required">*</span></label>
                                    <input   style="color: #000000;" class="form-control" data-validate-length-range="12" name="tbaptized" id="tbaptized" placeholder="10"  type="number">
                                </div>
                            </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                 ...
                                 echo form_dropdown('hw_fund_help_fw_op',$op_hw_fund_help_fw,"",$class_state);
                     ?>  
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                 ...
                                 echo form_dropdown('is_fw_live_in_mf',$op_yes_no,"",$class_state);
                     ?>  
                                </div>
                                <div class="form-group">
