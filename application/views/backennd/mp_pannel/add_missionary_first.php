                    ...
                    ?>
                                ...
                                <div class="form-group">
                                  <label for="name">Missionary Parter's Staff Sure Name<span class="required">(optional)</span></label>
                                    <input   style="color: #000000;" class="form-control" data-validate-length-range="6" name="mp_staff_sname" id="mp_staff_sname" placeholder="Jonh" type="text">
                                </div>
                                <div class="form-group">
                                  <label for="name">Missionary Parter's Staff ID<span class="required">(optional)</span></label>
                                    <input   style="color: #000000;" class="form-control" data-validate-length-range="6" name="mp_staff_id" id="mp_staff_id" placeholder="Jonh" type="text">
                                </div>
