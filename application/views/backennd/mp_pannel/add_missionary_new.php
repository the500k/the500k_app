                    ...
                    <input   style="color: #000000;" class="form-control" data-validate-length-range="6" name="missionary_id" id="missionary_id" type="hidden" value="<?php echo $missionary_id; ?>">
                                ...
                                <div class="form-group">
                                  <label for="name">First Name<span class="required">*</span></label>
                                    ...
                                    <input   style="color: #000000;" class="form-control" data-validate-length-range="6" name="middlename" id="middlename" value="Not Applicable" type="hidden">
                               
                                <div class="form-group">
                                  <label for="name">Sure Name<span class="required">(optional)</span></label>
                                    <input   style="color: #000000;" class="form-control" data-validate-length-range="6" name="surename" id="surename" placeholder="raj"  type="text">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                        ...
                                        <input value=1 name="fstatus" id="fstatus" required="required" type="radio" checked><label>Married</label>    &nbsp;&nbsp;&nbsp;
                                ...
                                <div class="form-group">
                                  <label for="name">FW's second phone number (if applicable)</label>
                                    <input   style="color: #000000;" class="form-control" data-validate-length-range="10" name="alt_phone_num" id="alt_phone_num" placeholder="9994985999"  type="number">
                                </div>
                                
                                <div class="form-group">
                                        <label>Does the FW have a smart phone that can work WhatsApp?</label><br>
                                        <input value=1 name="is_whatsapp_available" id="is_whatsapp_available"  type="radio" checked><label>Yes</label> &nbsp;&nbsp;&nbsp;   
                                        <input value=0 name="is_whatsapp_available" id="is_whatsapp_available"  type="radio"> <label>No</label>
                                                                 
                                </div>

                                <div class="form-group">
                                  <label for="name">Aadhar Number<span class="required">(optional)</span></label>
                                    <input   style="color: #000000;" class="form-control" data-validate-length-range="12" name="aadhar_number" id="aadhar_number" placeholder="425698785699" type="number">
                                </div>
                                <div class="form-group">
                                  <label for="name">State<span class="required">*</span></label>
                                   ...
                                   $class_state="id='state_id' class='form-control' style='#000000;' onchange='get_dst()' required='required' ";
                                    ...
                                    echo form_dropdown('state_id',$option_state,"",$class_state);
                                   ?>   
                                </div>
                                <div class="form-group">
                                  <label for="name">District<span class="required">*</span></label>
                                   ...
                                   $op_dis1[""]="";
                                    ...
                                    echo form_dropdown('district_id',$op_dis1,"",$class_dist);
                                   ?>   
                                </div>
