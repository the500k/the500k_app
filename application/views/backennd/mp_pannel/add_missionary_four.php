                      ...
                      echo form_open_multipart(base_url() . 'MP_Panel/submit_missionary/four' , array('data-toggle' => 'validator', 'role' => 'form','class'=>'cmxform form-horizontal'));
                          ...
                          ?>
                                ...
                                <div class="form-group">
                                 ...
                                 echo form_dropdown('is_supervisor_inducted',$op_yes_no,"",$class_state);
                                  ?>  
                                </div>
                                <div class="form-group">
                                 ...
                                 echo form_dropdown('is_supervisor_agree',$op_yes_no,"",$class_state);
                                  ?>  
                                </div>
                                <div class="form-group">
                                  <label for="name">How many 500k FW's is the Supervisor supervising already ?<span class="required">(optional)</span></label>
                                    <input   style="color: #000000;" class="form-control" data-validate-length-range="12" name="nof_supervisor" id="nof_supervisor" placeholder="10" type="number">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                 ...
                                 echo form_dropdown('is_FW_other_org',$op_yes_no,"",$class_state);
                                  ?>  
                                </div>
                                <div class="form-group">
