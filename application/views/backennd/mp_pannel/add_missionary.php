            ...
            <!------------------------------ extracted form start ------->
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-8 col-sm-8 col-xs-12">
                        <input   style="color: #000000;"  class="form-control col-md-7 col-xs-12" data-validate-length-range="6" name="missionary_code" id="missionary_code" placeholder="APNCKY10" required="required" type="text">
                      </div>
                    </div>
                    <div class="item form-group">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-8 col-sm-8 col-xs-12">
                        <input   style="color: #000000;"  class="form-control col-md-7 col-xs-12" data-validate-length-range="6" name="fname" id="fname" placeholder="Jonh" required="required" type="text">
                      </div>
                    </div>
                    <div class="item form-group">
                      ...
                      <div class="col-md-8 col-sm-8 col-xs-12">
                        <input   style="color: #000000;" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" name="surename" id="surename" placeholder="Singh" required="required" type="text">
                      </div>
                    </div>
                 <div class="item form-group">
