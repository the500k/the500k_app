            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                      ...
                      echo form_open_multipart(base_url() . 'MP_Panel/update_missionary/third' , array('data-toggle' => 'validator', 'role' => 'form','class'=>'cmxform form-horizontal'));
                          ...
                          ?>
                               <div class="form-group">
                                 ...
                                 echo form_dropdown('is_fw_trained_in_bc',$op_yes_no,$edit_data["is_fw_trained_in_bc"],$class_state);
                                  ?>  
                                </div>
                                 ...
                                 echo form_dropdown('BC_main',$op_BC_main,$edit_data["BC_main"],$class_state);
                                  ?>  
                                </div>
                                ...
                                <div class="form-group">
                                  <label for="name">Qualification obtained from the Bible College/Training Center. <span class="required">*</span></label>
                                    <input   style="color: #000000;" class="form-control" data-validate-length-range="12" name="qualification" id="qualification" placeholder="BA" required="required" type="text" value="<?php echo $edit_data["qualification"];?>" >
                                </div>

                                <div class="form-group">
                                  <label for="name">Number of years of training provided at Bible College/ Training Center<span class="required">*</span></label>
                                    <input   style="color: #000000;" class="form-control" data-validate-length-range="12" name="noyear_training" id="noyear_training" placeholder="3" required="required" type="number" value="<?php echo $edit_data["noyear_training"];?>">
                                </div>

                                <div class="form-group">
                                  <label for="name">Year of Graduation from Bible College<span class="required">*</span></label>
                                    <input   style="color: #000000;" class="form-control" data-validate-length-range="12" name="graduation_year" id="graduation_year" placeholder="2003" required="required" type="number" value="<?php echo $edit_data["graduation_year"];?>">
                                </div>

                                <div class="form-group">
                                  <label for="name">Other training courses completed and year completed</label>
                                    <input   style="color: #000000;" class="form-control" data-validate-length-range="12" name="other_course_year" id="other_course_year" placeholder="MA in 2003" type="text" value="<?php echo $edit_data["other_course_year"];?>">
                                </div>
                                ...
                                <div class="form-group">
                                 ...
                                 echo form_dropdown('is_fw_spk_english',$op_yes_no,$edit_data['is_fw_spk_english'],$class_state);
                                  ?>  
                                </div>
                                ...
                                <div class="form-group">
                                 ...
                                 echo form_dropdown('is_affiliated',$op_affiliated,$edit_data["is_affiliated"],$class_state);
                                  ?>  
                                </div>
                                ...
                                <div class="form-group">
                                 ...
                                 echo form_dropdown('affiliated_denomination',$op_DBC,$edit_data["affiliated_denomination"],$class_state);
                                  ?>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <textarea class="form-control" rows="6" name="desc_fw_aligns"><?php echo $edit_data['desc_fw_aligns']; ?></textarea>
                                </div>
                                ...
                                <div class="form-group">
                                 ...
                                 echo form_dropdown('is_fw_spk_hindi',$op_yes_no,$edit_data["is_fw_spk_hindi"],$class_state);
                                  ?>  
                                </div>
                                ...
                                <div class="form-group">
                                 ...
                                 $list=explode(",", $edit_data['other_spk_language']);

                                 echo form_dropdown('other_spk_language[]',$op_language,$list,$class_state);
                                  ?>  
                                </div>
