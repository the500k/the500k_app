  ...
  <!--main content start-->
    <section id="">
         ...
         <div class="row">
                <div class="col-lg-12">
                    ...
                    <tr>
                      ...
                      <th>New Field Workers</th>
                      <th>Attending worship</th>
                      <th>Baptised members</th>
        ...
        <tr>
         ...
         <td><?php echo $year_result[2021]['fw_new']+$njm['total_fw']+$bct['total_fw']+7; ?></td> 
       ...
       else
       {
        echo $yrslt['fw_retired_total']; 
         ...
         <td><?php echo $latest['lno_church'];  ?></td>
              ...
              <tr>
          <td colspan="4"><b>Averages per worker</b></td>
