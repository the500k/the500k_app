    ...
    <section id="main-content">
        ...
        <!-- form start-->
         <div class="row">
           ...
           <?php
                      echo form_open_multipart(base_url() . 'Admin/donar_report/' , array('data-toggle' => 'validator', 'role' => 'form','class'=>'cmxform form-horizontal'));
                    ?>
        ...
        <td><?php echo $id;  ?></td>
         ...
         <td><?php echo date('d-m-Y',strtotime($last_trans['trans_date1']));  ?></td>
