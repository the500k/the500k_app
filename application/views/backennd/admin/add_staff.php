                ...
                <div class="col-lg-12">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-8 col-sm-8 col-xs-12">
                        <input   style="color: #000000;"  id="adm_no" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" name="staff_no" id="staff_no" placeholder="2111" required="required" type="text">
                      </div>
                    </div>
                    <div class="item form-group">
                      ...
                      <div class="col-md-8 col-sm-8 col-xs-12">
                        <input   style="color: #000000;"  type="text" id="doj" name="doj" required="required" class="form-control col-md-7 col-xs-12 ed">
                      </div>
                    </div>
                 <div class="item form-group">
                       ...
                       <?php               
                            ...
                            if(!empty($department_lists))
                            {
                               foreach ($department_lists as $department) {
                                ...
                                echo form_dropdown('department_id',$option_dp,$department_id,$class_dp);
                     ?>
                      </div>
                    </div>
                        ...
                        <?php               
                            ...
                            if(!empty($designation_lists))
                            {
                               foreach ($designation_lists as $designation) {
                                ...
                                echo form_dropdown('designation_id',$option_des,$designation_id,$class_des);
                     ?>
                      </div>
                    </div>
