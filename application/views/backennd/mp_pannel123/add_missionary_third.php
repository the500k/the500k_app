                      ...
                      echo form_open_multipart(base_url() . 'MP_Panel/submit_missionary/third' , array('data-toggle' => 'validator', 'role' => 'form','class'=>'cmxform form-horizontal'));
                          ...
                          ?>
                               <div class="form-group">
                                 ...
                                 echo form_dropdown('is_fw_trained_in_bc',$op_yes_no,1,$class_state);
                                  ?>  
                                </div>


                                 <div class="form-group">
                                  <label for="name">Name of principal Bible College/Training Center attended<span class="required">*</span></label>
                                    <?php     
                                ...
                                <div class="form-group">
                                  <label for="name">Qualification obtained from principal Bible College/Training Center. <span class="required">*</span></label>
                                ...
                                <div class="form-group">
                                  <label for="name">Number of years of training provided at principal Bible College/ Training Center<span class="required">*</span></label>
                                ...
                                <div class="form-group">
                                  <label for="name">Year of Graduation from principal Bible College<span class="required">*</span></label>
                                ...
                                <div class="form-group">
                                  <label for="name">Other training courses completed and year completed<span class="required">*</span></label>
                                ...
                                <div class="form-group">
                                 ...
                                 $class_state="id='is_fw_spk_english' class='form-control' style='#000000;'";

                                 echo form_dropdown('is_fw_spk_english',$op_yes_no,1,$class_state);
                                  ?>  
                                </div>
                                ...
                                <div class="form-group">
                                 ...
                                 $class_state="id='is_affiliated' class='form-control' style='#000000;'";

                                 echo form_dropdown('is_affiliated',$op_affiliated,1,$class_state);
                                  ?>  
                                </div>
                                ...
                                <div class="form-group">
                                 ...
                                 $class_state="id='affiliated_denomination' class='form-control' style='#000000;'";

                                 echo form_dropdown('affiliated_denomination',$op_DBC,1,$class_state);
                                  ?>
                                </div>
                                ...
                                <div class="form-group">
                                 ...
                                 $class_state="id='is_fw_spk_hindi' class='form-control' style='#000000;'";

                                 echo form_dropdown('is_fw_spk_hindi',$op_yes_no,1,$class_state);
                                  ?>  
                                </div>
                                ...
                                <div class="form-group">
                                 ...
                                 $class_state="id='other_spk_language' class='form-control' style='#000000;'";

                                 echo form_dropdown('other_spk_language',$op_language,1,$class_state);
                                  ?>  
                                </div>
