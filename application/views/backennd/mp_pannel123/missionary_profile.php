                    ...
                    <div class="panel-body profile-information">
                       ...
                       <div class="col-md-6">
                           <div class="profile-desk">
                              <hr>
                               <h1><?php echo $profile_data['fname']." ".$profile_data['middlename']." ".$profile_data['surename']; ?></h1>
                               <hr>
                               <h3>
                                     <?php echo  "JLM";     ?>
                                        ...
                                        <div class="prf-box">
                                            ...
                                            <div class=" wk-progress pf-status">
                                                <div class="col-md-8 col-xs-8">
                                                 <a class="btn btn-primary" href="<?php echo base_url(); ?>/MP_panel/edit_missionary/first/<?php echo $missionary_id; ?>">
