                    ...
                    ?>
                     ...
                     ?>  
                                ...
                                <div class="form-group">
                                 ...
                                 $class_fw_active="id='is_fw_active_in_mf' class='form-control' style='#000000;' onchange='set_fields()' ";

                                 echo form_dropdown('is_fw_active_in_mf',$op_yes_no,2,$class_fw_active);
                     ?>  
                                </div>
