            ...
            <div class="col-md-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="tab-content tasi-tab">
                            <div id="overview" class="tab-pane active">
                                ...
                                <div class="row">
                                    &nbsp;&nbsp;&nbsp;
                                <?php    if($report_data['is_send_approval']==1){

                                               ?>
                                    <a class="btn btn-primary" href="<?php echo base_url(); ?>Admin2/edit_missionary_report/<?php echo $report_data['report_id']; ?>">
                                                    Edit Report...
                                                 </a>
                                             <?php }   
                                             ...
                                             if($param2!=1)
                                             {
                                              ...
                                              ?>
                                                 ...
                                                 <a class="btn btn-success" target="_blank" href="<?php echo base_url(); ?>Admin2/generate_fw_termreport/<?php echo $report_data['report_id']; ?>">
                                                    Verify Report Pdf
                                                 </a>
                                               <?php 
                                               }
                                               ...
                                               {
                                                ?>
                                                   <a class="btn btn-success" target="_blank" href="<?php echo base_url(); ?>Admin2/gsect_generate_fw_report/<?php echo $report_data['report_id']; ?>">
                                                    Verify Report Pdf
                                                 </a>
                                               ...
                                               ?>
                                                 <a class="btn btn-danger" href="<?php echo base_url(); ?>Admin2/send_to_googlesheet/<?php echo $report_data['report_id']; ?>">
                  ...
                  <table  class="table table-bordered table-striped" id="dynamic-table">
                    ...
                    <tr>
                      <th colspan="2"><center>FW's <?php echo $profile_data['fname']."'s ".$report_data['report_year']."-".$report_data['report_period']." - Report ";  ?></center></th>
