        ...
        <td>
                         <div class="btn-group">
                            ...
                            <ul role="menu" class="dropdown-menu">
                                ...
                                <li><a href="<?php echo base_url(); ?>Admin2/edit_missionary_report/<?php echo $missionary['report_id']; ?>">Edit</a></li>
                                <li><a href="<?php echo base_url(); ?>Admin2/delete_missionary_report/<?php echo $missionary['report_id']; ?>">Delete</a></li>
                              </ul>
                        </div>
             </td>
             </tr>
