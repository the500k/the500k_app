            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                      ...
                      echo form_open_multipart(base_url() . 'Admin2/report_gsect_update' , array('data-toggle' => 'validator', 'role' => 'form','class'=>'cmxform form-horizontal'));
                        ...
                        <div class="col-sm-6">
                           <label for="name">Period<span class="required">*</span></label>
                               <?php     
                                             ...
                                             $option_period[1]="R1 - Jan Feb Mar Apr";
                                             $option_period[2]="R2 - May Jun Jul Aug";
                                             $option_period[3]="R3 - Sep Oct Nov Dec";
                                ...
                                <?php     
                                   //print_r($missisonaries);exit;

                                     if(!empty($missisonaries))
                                          {
                                             foreach ($missisonaries as $missisonary) {

                                                $option_missionary[$missisonary['missionary_id']]=$missisonary['id']." --- ".$missisonary['name'];
