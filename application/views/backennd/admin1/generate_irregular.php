        ...
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                      ...
                      echo form_open_multipart(base_url() . 'Admin2/submit_budget/irregular' , array('data-toggle' => 'validator', 'role' => 'form','class'=>'cmxform form-horizontal'));
                       ...
                       if(!empty($mps))
                            {
                               ...
                               //   print_r($mp);exit;
                                 ...
                                 $class_mp="id='mp_id' class='form-control' style='#000000;' required='required'";
            ...
            echo form_dropdown('mp_id',$option_mp,$option_mp[1],$class_mp);
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-8 col-sm-8 col-xs-12">
                        <input   style="color: #000000;"  type="date" id="date" name="date" required="required" class="form-control col-md-7 col-xs-12 ed" placeholder="19-12-2019">
                      </div>
                    </div>
                    <div class="item form-group">
            ...
            echo form_dropdown('cost_type',$option_cost_type,$option_cost_type[1],$class_mp);
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Missionary ID(if any)<span class="required">*</span>
                      </label>
                      <div class="col-md-8 col-sm-8 col-xs-12">
                        <input   style="color: #000000;"  class="form-control col-md-7 col-xs-12" data-validate-length-range="6" name="missionaryID" id="missionaryID" placeholder="KK5263" type="text">
                      </div>
                    </div>
