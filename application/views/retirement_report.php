...
<br>
  ...
  <?php               
                     ...
                     ?> 
                        ...
                        <h5>Retirement Date</h5><br>
                        <p><b>Please Use correct date format like...04-05-2020</b></p><br>
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="19-12-2019" name="rdate">
                        </div>
                        <h5>FI deadline status</h5><br>
                         <div class="input-group">
                            <div class="rs-select2 js-select-simple select--no-search">
                                <select name="fi_deadline">           
