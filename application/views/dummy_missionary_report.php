        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <h2 class="title">Reporter Deatails</h2>   <?php 
  ...
  <?php               
                     ...
                     ?> 
                        ...
                        <br><br>
                         <div class="row row-space">
                            ...
                            <div class="col-1">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <input class="input--style-1" type="text" placeholder="#Coming for prayer" name="v1_cfprayer">
                                    </div>
                                </div>
                            </div>
                            <div class="col-1">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <input class="input--style-1" type="text" placeholder="#Baptisms" name="v1_baptisms">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-1">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <input class="input--style-1" type="text" placeholder="#Coming for prayer" name="v2_cfprayer">
                                    </div>
                                </div>
                            </div>
                            <div class="col-1">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <input class="input--style-1" type="text" placeholder="#Baptisms" name="v2_baptisms">
                                    </div>
                                </div>
                            </div>
                        </div>
                <div class="row row-space">
                            ...
                            <div class="col-1">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <input class="input--style-1" type="text" placeholder="#Coming for prayer" name="v3_cfprayer">
                                    </div>
                                </div>
                            </div>
                            <div class="col-1">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <input class="input--style-1" type="text" placeholder="#Baptisms" name="v3_baptisms">
                                    </div>
                                </div>
                            </div>
                </div>
                <div class="row row-space">
                            ...
                            <div class="col-1">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <input class="input--style-1" type="text" placeholder="#Coming for prayer" name="v4_cfprayer">
                                    </div>
                                </div>
                            </div>
                            <div class="col-1">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <input class="input--style-1" type="text" placeholder="#Baptisms" name="v4_baptisms">
                                    </div>
                                </div>
                            </div>
                </div>
                <div class="row row-space">
                            ...
                            <div class="col-1">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <input class="input--style-1" type="text" placeholder="#Coming for prayer" name="v5_cfprayer">
                                    </div>
                                </div>
                            </div>
                            <div class="col-1">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <input class="input--style-1" type="text" placeholder="#Baptisms" name="v5_baptisms">
                                    </div>
                                </div>
                            </div>
                 </div>
                 <div class="row row-space">
                            ...
                            <div class="col-1">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <input class="input--style-1" type="text" placeholder="#Coming for prayer" name="v6_cfprayer">
                                    </div>
                                </div>
                            </div>
                            <div class="col-1">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <input class="input--style-1" type="text" placeholder="#Baptisms" name="v6_baptisms">
                                    </div>
                                </div>
                            </div>
                 </div>
                 ...
                 <div class="row row-space">
                            ...
                            <div class="col-1">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <input class="input--style-1" type="text" placeholder="#Coming for prayer" name="v7_cfprayer">
                                    </div>
                                </div>
                            </div>
                            <div class="col-1">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <input class="input--style-1" type="text" placeholder="#Baptisms" name="v7_baptisms">
                                    </div>
                                </div>
                            </div>
                </div>
                <div class="row row-space">
                            ...
                            <div class="col-1">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <input class="input--style-1" type="text" placeholder="#Coming for prayer" name="v8_cfprayer">
                                    </div>
                                </div>
                            </div>
                            <div class="col-1">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <input class="input--style-1" type="text" placeholder="#Baptisms" name="v8_baptisms">
                                    </div>
                                </div>
                            </div>
                </div>
                <div class="row row-space">
                            ...
                            <div class="col-1">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <input class="input--style-1" type="text" placeholder="#Coming for prayer" name="v9_cfprayer">
                                    </div>
                                </div>
                            </div>
                            <div class="col-1">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <input class="input--style-1" type="text" placeholder="#Baptisms" name="v9_baptisms">
                                    </div>
                                </div>
                            </div>
                </div>
                <div class="row row-space">
                            ...
                            <div class="col-1">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <input class="input--style-1" type="text" placeholder="#Coming for prayer" name="v10_cfprayer">
                                    </div>
                                </div>
                            </div>
                            <div class="col-1">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <input class="input--style-1" type="text" placeholder="#Baptisms" name="v10_baptisms">
                                    </div>
                                </div>
                            </div>
                </div>
  ...
  $().ready(function() {
    ...
    $(".studentForm").validate({
      rules: {
        ...
        name: "required",
        v1_name:"required",
        v1_cfprayer:"required",
        v1_baptisms:"required",
        fname:"required",
      ...
      messages: {
          ...
          v1_cfprayer: "Please enter no of people coming for the prayer",
          v1_baptisms: "Please enter no of baptisms",
