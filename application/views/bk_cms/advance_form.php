...
<!-- Mirrored from bucketadmin.themebucket.net/advanced_form.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 03 Nov 2018 08:47:03 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!--Core CSS -->
    <link href="<?php echo base_url();?>/bk_style/bs3/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo base_url();?>/bk_style/css/bootstrap-reset.css" rel="stylesheet">
    <link href="<?php echo base_url();?>/bk_style/font-awesome/css/font-awesome.css" rel="stylesheet" />

    <link rel="stylesheet" href="<?php echo base_url();?>/bk_style/css/bootstrap-switch.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/bk_style/js/bootstrap-fileupload/bootstrap-fileupload.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/bk_style/js/bootstrap-wysihtml5/bootstrap-wysihtml5.css" />

    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/bk_style/js/bootstrap-datepicker/css/datepicker.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/bk_style/js/bootstrap-timepicker/css/timepicker.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/bk_style/js/bootstrap-colorpicker/css/colorpicker.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/bk_style/js/bootstrap-daterangepicker/daterangepicker-bs3.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/bk_style/js/bootstrap-datetimepicker/css/datetimepicker.css" />

    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/bk_style/js/jquery-multi-select/css/multi-select.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/bk_style/js/jquery-tags-input/jquery.tagsinput.css" />

    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/bk_style/js/select2/select2.css" />

    <!-- Custom styles for this template -->
    <link href="<?php echo base_url();?>/bk_style/css/style.css" rel="stylesheet">
    <link href="<?php echo base_url();?>/bk_style/css/style-responsive.css" rel="stylesheet" />

    <!-- Just for debugging purposes. Don't actually copy this line! -->
    <!--[if lt IE 9]>
    <script src="<?php echo base_url();?>/bk_style/js/ie8-responsive-file-warning.js"></script><![endif]-->
...
<script src="<?php echo base_url();?>/bk_style/js/jquery-1.10.2.min.js"></script>
<script src="<?php echo base_url();?>/bk_style/bs3/js/bootstrap.min.js"></script>
<script src="<?php echo base_url();?>/bk_style/js/jquery-ui-1.9.2.custom.min.js"></script>
...
<script src="<?php echo base_url();?>/bk_style/js/bootstrap-switch.js"></script>

<script type="text/javascript" src="<?php echo base_url();?>/bk_style/js/fuelux/js/spinner.min.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>/bk_style/js/bootstrap-fileupload/bootstrap-fileupload.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>/bk_style/js/bootstrap-wysihtml5/wysihtml5-0.3.0.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>/bk_style/js/bootstrap-wysihtml5/bootstrap-wysihtml5.js"></script>

<script type="text/javascript" src="<?php echo base_url();?>/bk_style/js/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>/bk_style/js/bootstrap-datetimepicker/js/bootstrap-datetimepicker.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>/bk_style/js/bootstrap-daterangepicker/moment.min.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>/bk_style/js/bootstrap-daterangepicker/daterangepicker.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>/bk_style/js/bootstrap-colorpicker/js/bootstrap-colorpicker.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>/bk_style/js/bootstrap-timepicker/js/bootstrap-timepicker.js"></script>

<script type="text/javascript" src="<?php echo base_url();?>/bk_style/js/jquery-multi-select/js/jquery.multi-select.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>/bk_style/js/jquery-multi-select/js/jquery.quicksearch.js"></script>

<script type="text/javascript" src="<?php echo base_url();?>/bk_style/js/bootstrap-inputmask/bootstrap-inputmask.min.js"></script>

<script src="<?php echo base_url();?>/bk_style/js/jquery-tags-input/jquery.tagsinput.js"></script>

<script src="<?php echo base_url();?>/bk_style/js/select2/select2.js"></script>
<script src="<?php echo base_url();?>/bk_style/js/select-init.js"></script>


<!--common script init for all pages-->
<script src="<?php echo base_url();?>/bk_style/js/scripts.js"></script>

<script src="<?php echo base_url();?>/bk_style/js/toggle-init.js"></script>
...
<!-- Mirrored from bucketadmin.themebucket.net/advanced_form.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 03 Nov 2018 08:47:19 GMT -->
</html>
